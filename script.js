/* =========================================================
   Mariel Store — Static (no backend, no database)
   - Injects shared header & footer
   - Cart and wishlist using localStorage (browser only)
   - Mobile menu, toasts, reveal-on-scroll
   - Product search/filter, product detail
   ========================================================= */
...
/* =========================================================
   CONTACT FORM (no backend — just confirms submission)
   ========================================================= */
function bindContactForm() {
  ...
  f.addEventListener("submit", (e) => {
    e.preventDefault();
    toast("Message sent! We'll get back to you soon.", "ok");
    f.reset();
  });
}
...
function wireEvents() {
  document.addEventListener("click", (e) => {
    ...
    if (t.id === "checkout-btn") {
      ...
      setCart([]);
      closeCart();
      toast("Order placed! We'll contact you soon to confirm.", "ok");
      return;
    }
